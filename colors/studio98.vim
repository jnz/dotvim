...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#800000', '#f3b63c', '#fff953', '#008000', '#0000ff', '#000080', '#357ec7', '#545454', '#b3b3b3', '#dfdfdf', '#f6f6f6', '#ffffff', '#64ffff', '#ff00ff', '#00ffff']
endif
if has('nvim')
  let g:terminal_color_0 = '#000000'
  let g:terminal_color_1 = '#800000'
  let g:terminal_color_2 = '#f3b63c'
  let g:terminal_color_3 = '#fff953'
  let g:terminal_color_4 = '#008000'
  let g:terminal_color_5 = '#0000ff'
  let g:terminal_color_6 = '#000080'
...
hi DiffAdd guifg=#008000 guibg=#ffffff gui=bold,reverse cterm=bold,reverse
...
hi DiffText guifg=#800000 guibg=fg gui=bold,reverse cterm=bold,reverse
hi Directory guifg=#000080 guibg=NONE gui=NONE cterm=NONE
hi EndOfBuffer guifg=#b3b3b3 guibg=#f6f6f6 gui=bold cterm=bold
hi ErrorMsg guifg=#800000 guibg=#ffffff gui=reverse cterm=reverse
...
hi MoreMsg guifg=#0000ff guibg=#ffffff gui=NONE cterm=NONE
...
hi PmenuSel guifg=#ffffff guibg=#000080 gui=NONE cterm=NONE
hi PmenuMatch guifg=#545454 guibg=#f6f6f6 gui=NONE cterm=NONE
hi PmenuMatchSel guifg=#b3b3b3 guibg=#000080 gui=NONE cterm=NONE
hi PmenuThumb guifg=NONE guibg=#000000 gui=NONE cterm=NONE
hi Question guifg=#ffffff guibg=#000080 gui=NONE cterm=NONE
hi Search guifg=#fff953 guibg=fg gui=reverse cterm=reverse
hi QuickFixLine guifg=#ffffff guibg=#000080 gui=NONE cterm=NONE
hi SignColumn guifg=#000000 guibg=#ffffff gui=NONE cterm=NONE
hi SpecialKey guifg=#b3b3b3 guibg=#ffffff gui=NONE cterm=NONE
hi SpellBad guifg=#800000 guibg=#ffffff guisp=#800000 gui=undercurl cterm=undercurl
hi SpellCap guifg=#000000 guibg=#ffffff guisp=#0000ff gui=undercurl cterm=undercurl
hi SpellLocal guifg=#000000 guibg=#ffffff guisp=#008000 gui=undercurl cterm=undercurl
hi SpellRare guifg=#000000 guibg=#ffffff guisp=#800000 gui=undercurl cterm=undercurl
...
hi Visual guifg=#ffffff guibg=#000080 gui=NONE cterm=NONE
hi VisualNOS guifg=#dfdfdf guibg=#545454 gui=NONE cterm=NONE
hi WarningMsg guifg=#800000 guibg=#ffffff gui=NONE cterm=NONE
hi WildMenu guifg=#ffffff guibg=#000080 gui=NONE cterm=NONE
hi Comment guifg=#008000 guibg=NONE gui=NONE cterm=NONE
hi Constant guifg=#000080 guibg=NONE gui=NONE cterm=NONE
hi Error guifg=#800000 guibg=#ffffff gui=reverse cterm=reverse
hi Identifier guifg=#0000ff guibg=NONE gui=NONE cterm=NONE
hi Ignore guifg=#000000 guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#0000ff guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#000000 guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#0000ff guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#ffffff guibg=#000080 gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=88 ctermbg=fg cterm=bold,reverse
  hi Directory ctermfg=18 ctermbg=NONE cterm=NONE
  hi EndOfBuffer ctermfg=249 ctermbg=255 cterm=bold
  hi ErrorMsg ctermfg=88 ctermbg=231 cterm=reverse
  ...
  hi MoreMsg ctermfg=21 ctermbg=231 cterm=NONE
  ...
  hi Search ctermfg=227 ctermbg=fg cterm=reverse
  ...
  hi SpellBad ctermfg=88 ctermbg=231 cterm=undercurl
  ...
  hi WarningMsg ctermfg=88 ctermbg=231 cterm=NONE
...
" Color: red           #800000                   ~         DarkRed
" Color: orange        #f3b63c                   ~         DarkYellow
" Color: yellow        #fff953                   ~         LightYellow
" Color: green         #008000                   ~         DarkGreen
" Color: blue          #0000ff                   ~         LightBlue
...
" Color: brightmagenta rgb(255,   0, 255)        ~         LightMagenta
